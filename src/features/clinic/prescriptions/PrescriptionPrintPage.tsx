              ...
              <header>
                ...
                <div className="flex items-center justify-between gap-1 mt-1">
                  ...
                  <div className="w-20 shrink-0 flex items-center justify-start">
                    {clinic.logo_url ? (
                      <img src={clinic.logo_url} alt="" className="h-20 w-20 object-contain" />
                    ) : (
                  ...
                  <div className="text-center flex-1 min-w-0 px-2">
                    <div
                      className="font-black uppercase text-black leading-none tracking-[0.03em] whitespace-nowrap text-[43px]"
                      style={{
                    ...
                    {lh.tagline && (
                      <div
                        className="text-[17.5px] italic text-black tracking-wide leading-normal mt-0.5 whitespace-nowrap"
                        style={{
                  ...
                  <div className="flex justify-center flex-wrap gap-x-8 gap-y-1.5 mt-2 text-center">
                    {doctors.map((d, i) => (
                      <div key={i} className="text-center leading-[1.4]">
                        <div className="text-[28px] font-bold text-black leading-[1.25]">{d.name}</div>
                        {d.qualification && (
                          <div className="text-[15px] text-black mt-0.5 leading-[1.4]">{d.qualification}</div>
                        )}
                      </div>
                    ))}
                  </div>

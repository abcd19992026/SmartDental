...
Deno.serve(async (req) => {
  ...
  // A super admin must not be able to reset another super admin's password through this route
  // -- only clinic users (owner/receptionist) are in scope, identified by having a clinic_id.
